...
<?php 
    ...
    $id = $_GET["id"];
    $sql = "SELECT * from harvest INNER JOIN members ON members.memberid = harvest.member WHERE hid = '$id'";
    $stmt = $db->prepare($sql);
    $stmt->execute();
            ...
            if (isset($_POST["update_harvest"])) {
              ...
              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if($row == true){
                      ...
                      echo '<script>window.location="harvest_edit.php";</script>';  
                    }
                  }
                }
?>
          ...
          <input type="hidden" value="<?php echo $row['hid']; ?>">
            ...
            <div class="form-group">
                  <div class="form-label-group">
                    <input type="text" style="font-size: 15px;" value="<?php echo $firstname . " " . $othername . " " . $surname; ?>" disabled class="form-control" autofocus required>
