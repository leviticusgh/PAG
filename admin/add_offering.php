  ...
  <body class="bg-dark">
    ...
    <div class="container">
      <div class="card card-register mx-auto mt-5">
        <div class="card-header">Add Offering</div>
        <div class="card-body">
          <form method="post">

            <div class="form-group">
                  <div class="form-label-group">
                 <input type="text" id="amount" name="amount" class="form-control" placeholder="Amount" autofocus required>
                 <label for="Amount">Amount (In Figures)</label>
              </div>
            </div>
            
            <div class="form-group">
            <input  class="form-control" id="submit" type="submit" name="add_offering" value="Add" >
</div>
          </form>
        </div>
      </div>
